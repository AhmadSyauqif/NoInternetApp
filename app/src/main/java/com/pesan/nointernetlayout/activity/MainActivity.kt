package com.pesan.nointernetlayout.activity
...
import com.pesan.nointernetlayout.adapter.MainAdapter
                ...
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        for (i in 0 until jsonArray.length()) {
                            ...
                            dataApi.strNamae = temp.getString("name")
                            dataApi.strVersiom = temp.getString("ver")
